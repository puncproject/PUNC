...
while(True):
    ...
    fig = plt.figure(1)
    fig.clear()
    plt.plot(data[:,0], data[:,1],label='electrons')
    plt.plot(data[:,0], data[:,2],label='ions')
    ...
    fig = plt.figure(2)
    fig.clear()
    plt.plot(data[:,0], data[:,3],label='kinetic')
    plt.plot(data[:,0], data[:,4],label='potential')
    plt.plot(data[:,0], data[:,3]+data[:,4],':',label='total')
    plt.legend(loc="lower left")
    plt.xlabel("Timestep")
