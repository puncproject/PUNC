...
pop.init_new_specie('electron', normalization='particle scaling', v_thermal=1./Rp, num_per_cell=npc)
pop.init_new_specie('proton',   normalization='particle scaling', v_thermal=1./(np.sqrt(1836.)*Rp), num_per_cell=npc)
