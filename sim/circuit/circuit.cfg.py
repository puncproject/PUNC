...
fname = "../../mesh/2D/two_circles_in_rectangle"
...
npc = 2             # Number of particles per cell
...
species.append(-e, me, ne, vthe, vde, npc=npc, ext_bnd=ext_bnd)
species.append(e, mp, ne, vthi, vdi, npc=npc, ext_bnd=ext_bnd)
